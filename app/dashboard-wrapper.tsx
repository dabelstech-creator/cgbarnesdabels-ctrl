    ...
    return (
      <div className="min-h-screen bg-[#030712] text-slate-100 flex flex-col items-center justify-center font-sans">
        <div className="flex flex-col items-center space-y-4">
          ...
          <h2 className="text-xl font-semibold tracking-tight text-white">Authenticating...</h2>
          <p className="text-xs text-slate-400 font-mono">Verifying secure credentials</p>
        </div>
      </div>
    );
  }
